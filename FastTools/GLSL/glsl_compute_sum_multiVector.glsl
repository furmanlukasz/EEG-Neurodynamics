...
void main()
{
	vec4 color, sftVectors, sftVectorsShift;
	...
	//float DistSFT_Vectors = length((sftVectors.r-sftVectorsShift.r)*abs(sftVectors.r-sftVectorsShift.r));
	//DistSFT_Vectors = length(sftVectors.r-sftVectorsShift.r)*abs(sftVectors.r-sftVectorsShift.r);
